...
const createCowToDb = (cowData) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield cow_model_1.Cow.create(cowData);
    yield result.populate('user');
    return result;
});
...
const deleteCow = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield cow_model_1.Cow.findByIdAndDelete(id).populate('user');
    return result;
});
exports.CowService = {
    createCowToDb,
